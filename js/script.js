...
(function() {
  $(document).ready(function() {
    var c, canvas, pivotpoints, screenWidth, ycommon, yfromtop;
    pivotpoints = [
      {
        id: 0,
        x: 129,
    ...
    $('.Label_listItem').on("click", function() {
      var activePoint, compElement, compositionSec, elements, extendPoint, i, j, len, len1, pivotpointList, results;
